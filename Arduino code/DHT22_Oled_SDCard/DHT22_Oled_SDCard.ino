...
// Initialize the ethernet stuff

  byte mac[] = { 0x90, 0xAA, 0xDA, 0x0E, 0xF4, 0x77 };
  byte ip[] = {192, 168, 1, 17}; //Enter the IP of ethernet shield
  byte serv[] = {192, 168, 1, 15}; //Enter the IPv4 address
...
bool dht_test(float* humPerc, float* temp, float* heatIndex)
{
  ...
  *heatIndex = 0;
  ...
  File sdcard_file = SD.open("test.txt", FILE_WRITE);
...
sdcard_file.print("  Moisture: ");
sdcard_file.println(sensorValue);

//sdcard_file.print("  Heat Index: ");

//sdcard_file.println(hic);
...
sdcard_file.close();
  ...
  cliente.println(sensorValue);
  //delay(60000);
  
  //end send sensor values
  }
  else {
